...
Highly recommended overall resources: Kara McKinley’s write-ups, Steve Ramirez’s materials, Laurel Gabard-Dunham’s resources page…  Future PI slack could also be great (I found this a bit late and didn’t really end up using it; the volume of posts felt a bit overwhelming to me) 
...
First application deadline	First round interviews	Full interviews	Offers	Committed
...
Additional resources: UCSF has an example chalk talk here and gladstone has one here. More and more programs (not UCSF, sadly) are starting to open up candidate chalk talks to trainees – definitely go! 
