...
**Grad Students:** Our lab is affiliated with the [Neuroscience graduate program](https://depts.washington.edu/neurogrd/) and the [Molecular Medicine & Mechanisms of Disease](https://sites.uw.edu/m3d/) (M3D) graduate program. All graduate students **must** be admitted through these programs; the lab cannot directly accept students. We will be accepting rotation students from these programs in Fall 2025. Please contact Anna if you've been admitted to a different UW graduate program and are interested in the lab.
